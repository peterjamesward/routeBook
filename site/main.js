...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{active: $elm$core$Maybe$Nothing, entries: $author$project$Main$content},
		A2(
			$elm$random$Random$generate,
			$author$project$Main$Randomized,
			$elm_community$random_extra$Random$List$shuffle($author$project$Main$content)));
};
...
var $author$project$Main$SelectEntry = function (a) {
	return {$: 'SelectEntry', a: a};
};
...
var $smucode$elm_flat_colors$FlatColors$BritishPalette$electromagnetic = A3($mdgriffith$elm_ui$Element$rgb255, 47, 54, 64);
...
var $smucode$elm_flat_colors$FlatColors$BritishPalette$downloadProgress = A3($mdgriffith$elm_ui$Element$rgb255, 76, 209, 55);
var $smucode$elm_flat_colors$FlatColors$BritishPalette$lynxWhite = A3($mdgriffith$elm_ui$Element$rgb255, 245, 246, 250);
var $smucode$elm_flat_colors$FlatColors$BritishPalette$nasturcianFlower = A3($mdgriffith$elm_ui$Element$rgb255, 232, 65, 24);
...
var $author$project$Main$withBorder = F2(
	function (colour, width) {
		return $mdgriffith$elm_ui$Element$el(
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Border$color(colour),
					$mdgriffith$elm_ui$Element$Border$width(width),
					$mdgriffith$elm_ui$Element$Border$rounded(width * 4),
					$mdgriffith$elm_ui$Element$Background$color($smucode$elm_flat_colors$FlatColors$ChinesePalette$white)
				]));
	});
var $author$project$Main$tricolore = function (width) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeL,
				$elm$core$Basics$identity,
				A2($author$project$Main$withBorder, $smucode$elm_flat_colors$FlatColors$BritishPalette$downloadProgress, width)),
			A2($author$project$Main$withBorder, $smucode$elm_flat_colors$FlatColors$BritishPalette$lynxWhite, width)),
		A2($author$project$Main$withBorder, $smucode$elm_flat_colors$FlatColors$BritishPalette$nasturcianFlower, width));
};
...
var $author$project$Main$entryDetail = function (entry) {
	var closeButton = A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($smucode$elm_flat_colors$FlatColors$BritishPalette$chainGangGrey),
			...
			]),
		{
			label: $mdgriffith$elm_ui$Element$html(
				A2(
					...
					_List_Nil,
					A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$x))),
			onPress: $elm$core$Maybe$Just(
				$author$project$Main$SelectEntry($elm$core$Maybe$Nothing))
		});
	return A2(
		$author$project$Main$tricolore,
		5,
		A2(
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Font$color($smucode$elm_flat_colors$FlatColors$BritishPalette$electromagnetic),
									$mdgriffith$elm_ui$Element$Font$bold,
									$mdgriffith$elm_ui$Element$padding(10)
								]),
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(entry.title)
								])),
							closeButton
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$padding(10),
							$mdgriffith$elm_ui$Element$Font$color($smucode$elm_flat_colors$FlatColors$BritishPalette$blueNights)
						]),
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$html(
							A2($elm_explorations$markdown$Markdown$toHtml, _List_Nil, entry.content))
						]))
				])));
};
...
var $author$project$Main$entryAsHeading = function (entry) {
	return A2(
		$author$project$Main$tricolore,
		2,
		A2(
				...
				]),
			{
				...
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$SelectEntry(
...
var $author$project$Main$homeScreen = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$entryAsHeading, model.entries));
};
...
var $author$project$Main$notes = A2(
	...
	A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('Most cycling clubs now feature “half-wheeling” as the Number One thing not to do on a group ride. '),
				$mdgriffith$elm_ui$Element$text('The Gregarios were one of the very first clubs to feature a Ride Etiquette Page on a club website. '),
				$mdgriffith$elm_ui$Element$text('Much of our Etiquette content has been adopted by other clubs up and down the country.'),
				$mdgriffith$elm_ui$Element$text('Our Paceline and Chaingang instructions have been copied by many clubs.')
			])));
...
var $author$project$Main$view = function (model) {
	return A2(
				...
				function () {
					...
					if (_v0.$ === 'Just') {
						...
						return A2(
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY, $mdgriffith$elm_ui$Element$scrollbarY]),
							$author$project$Main$entryDetail(entry));
					} else {
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Main$homeScreen(model),
